            ...
            异步请求会被分为
                1.简单请求
                    仅当POST方法的Content-Type值等于下列之一才算作简单请求
                        ...
                        请求中的任意 XMLHttpRequestUpload 对象均没有注  册任何事件监听器； XMLHttpRequestUpload 对象可以使用 XMLHttpRequest.upload 属性访问。
...
10.计算机网络体系结构
    ...
    五层协议(并不存在 讲课用)
        ...
        数据链路层
        物理层
11.TCP和UDP(传输层协议)概念 区别 应用场景 TCP三次握手四次挥手
