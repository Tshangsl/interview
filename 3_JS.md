        ...
        符号用来做什么
            ...
            2.作为对象属性的键值
                ...
                使用括号语法 可以使用符号作为属性的键值
                    ...
                    JSON.stringfy()等方法忽略
                    (序列化对象中不想被包含的属性 符号Symbol是一个理想的选择)
                    (序列化对象中不想被包含的属性 符号Symbol是一个理想的选择)
            3.使用Symbol替代常量
...
4.JS中arguments
    前言：
        ...
        开发者定义的函数可以接受任意个数的参数(但根据Netscape的文档 最多可接收255个)而不会引发任何错误 
        任何遗漏的参数都会以undefined传递给函数 
        多余的参数将忽略
